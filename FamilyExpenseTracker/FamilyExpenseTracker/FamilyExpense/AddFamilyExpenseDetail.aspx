<%@ Page Language="C#" Title="Add Family Expense Detail Page" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddFamilyExpenseDetail.aspx.cs" Inherits="FamilyExpenseTracker.AddFamilyExpenseDetail" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-md-6">
            <div class="card">
                <div class="card-header bg-primary text-white">Add Family Expense Detail</div>
                <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <asp:TextBox type="date" class="form-control" id="date" name="date" runat="server"></asp:TextBox>

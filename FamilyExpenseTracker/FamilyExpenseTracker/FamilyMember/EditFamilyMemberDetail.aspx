<%@ Page Language="C#" Title="Edit FamilyMember Detail" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditFamilyMemberDetail.aspx.cs" Inherits="FamilyExpenseTracker.FamilyMember.EditFamilyMember" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
                <div class="card">
                    <div class="card-header bg-primary text-white">EditFamilyMemberDetail</div>
                    <div class="card-body">
                        <div class="form-group">
                          <label for="name">Name:</label>
                          <asp:HiddenField ID="fmid" runat="server"/>
